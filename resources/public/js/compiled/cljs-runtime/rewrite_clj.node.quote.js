...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k37138,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37138,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__37149){
var vec__37150 = p__37149;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37150,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37150,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37139,other37140){
var self__ = this;
var this37139__$1 = this;
return (((!((other37140 == null)))) && ((((this37139__$1.constructor === other37140.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37139__$1.tag,other37140.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37139__$1.prefix,other37140.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37139__$1.sym,other37140.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37139__$1.children,other37140.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37139__$1.__extmap,other37140.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k37138){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k37138);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__37137){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__37171 = cljs.core.keyword_identical_QMARK_;
var expr__37172 = k__4511__auto__;
if(cljs.core.truth_((pred__37171.cljs$core$IFn$_invoke$arity$2 ? pred__37171.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__37172) : pred__37171.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__37172)))){
return (new rewrite_clj.node.quote.QuoteNode(G__37137,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37171.cljs$core$IFn$_invoke$arity$2 ? pred__37171.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__37172) : pred__37171.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__37172)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__37137,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37171.cljs$core$IFn$_invoke$arity$2 ? pred__37171.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__37172) : pred__37171.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__37172)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__37137,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37171.cljs$core$IFn$_invoke$arity$2 ? pred__37171.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__37172) : pred__37171.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__37172)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__37137,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__37137),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__37137){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__37137,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__37141){
var extmap__4542__auto__ = (function (){var G__37197 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__37141,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__37141)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__37197);
} else {
return G__37197;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__37141),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__37141),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__37141),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37141),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var G__37237 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__37237;
continue;
}
break;
...
var G__37238 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__37238;
continue;
}
break;
...
var G__37239 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__37239;
continue;
}
break;
...
var G__37241 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__37241;
continue;
}
break;
