...
var G__38878 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__38878;
continue;
} else {
var G__38879 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__38879;
continue;
}
} else {
var G__38906 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__38906;
continue;
}
}
...
var G__38770 = zloc;
var G__38771 = (function (){var G__38772 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__38773 = zloc;
var G__38773__$1 = (((G__38773 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__38773) : rewrite_clj.zip.node.call(null,G__38773)));
if((G__38773__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__38773__$1) : zprint.zutil.edn_STAR_.call(null,G__38773__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__38772) : rewrite_clj.zip.root.call(null,G__38772));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__38770,G__38771) : rewrite_clj.zip.replace.call(null,G__38770,G__38771));
});
/**
...
var G__38947 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__38947;
continue;
}
break;
...
var G__38948 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__38949 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__38948;
out = G__38949;
continue;
} else {
...
var G__38950 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__38951 = cljs.core.next(new_loc);
var G__38952 = replaced_loc;
nloc = G__38950;
new_loc = G__38951;
last_loc = G__38952;
continue;
...
return zprint.rewrite.sort_val((function (){var G__38832 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__38832) : rewrite_clj.zip.down.call(null,G__38832));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__38835_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__38835_SHARP_) : rewrite_clj.zip.tag.call(null,p1__38835_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__38835_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__38835_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
