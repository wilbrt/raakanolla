...
var vec__40617 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__40622 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40622,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40622,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40617,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40617,(1),null);
...
var vec__40641 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40641,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40641,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40641,(2),null);
var vec__40644 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40644,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40644,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40644,(2),null);
...
var G__40765 = cljs.core.next(style_vec);
var G__40766 = ends_w_blanks_QMARK_;
var G__40767 = tuple;
var G__40768 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__40765;
previous_ends_w_blanks_QMARK_ = G__40766;
previous_tuple = G__40767;
out = G__40768;
continue;
}
break;
...
var len__4864__auto___40769 = arguments.length;
var i__4865__auto___40770 = (0);
while(true){
if((i__4865__auto___40770 < len__4864__auto___40769)){
args__4870__auto__.push((arguments[i__4865__auto___40770]));

var G__40771 = (i__4865__auto___40770 + (1));
i__4865__auto___40770 = G__40771;
continue;
} else {
}
break;
...
var G__40783 = (i__4865__auto___40782 + (1));
i__4865__auto___40782 = G__40783;
continue;
} else {
}
break;
...
var args__4870__auto__ = [];
var len__4864__auto___40784 = arguments.length;
var i__4865__auto___40785 = (0);
while(true){
if((i__4865__auto___40785 < len__4864__auto___40784)){
args__4870__auto__.push((arguments[i__4865__auto___40785]));

var G__40786 = (i__4865__auto___40785 + (1));
i__4865__auto___40785 = G__40786;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq40694){
var G__40695 = cljs.core.first(seq40694);
var seq40694__$1 = cljs.core.next(seq40694);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40695,seq40694__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___40792 = arguments.length;
var i__4865__auto___40794 = (0);
while(true){
if((i__4865__auto___40794 < len__4864__auto___40792)){
args__4870__auto__.push((arguments[i__4865__auto___40794]));

var G__40795 = (i__4865__auto___40794 + (1));
i__4865__auto___40794 = G__40795;
continue;
} else {
}
break;
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__40701,form){
var vec__40702 = p__40701;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40702,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40702,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40702,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40702,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__40705 = (cljs.core.truth_((function (){var and__4251__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40705,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40705,(1),null);
...
var G__40807 = cljs.core.next(sos);
var G__40808 = comment_QMARK_;
var G__40809 = (function (){var or__4253__auto__ = (!(empty_string_QMARK_));
if(or__4253__auto__){
return or__4253__auto__;
} else {
...
var G__40810 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__40807;
previous_comment_QMARK_ = G__40808;
start_interpolating_QMARK_ = G__40809;
out = G__40810;
continue;
}
break;
...
try{var vec__40717 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40717,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40717,(1),null);
...
var vec__40720 = (cljs.core.truth_((function (){var or__4253__auto__ = range_start__$1;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40720,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40720,(1),null);
...
var vec__40723 = (cljs.core.truth_((function (){var and__4251__auto__ = actual_start;
if(cljs.core.truth_(and__4251__auto__)){
return actual_end;
} else {
return and__4251__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40723,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40723,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40723,(2),null);
...
var forms = (function (){var G__40737 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__40737) : zprint.zutil.edn_STAR_.call(null,G__40737));
})();
