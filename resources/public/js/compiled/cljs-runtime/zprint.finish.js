...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__36947_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__36947_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__36947_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__36948){
var vec__36949 = p__36948;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36949,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36949,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__36952,s,color,element,idx){
var map__36953 = p__36952;
var map__36953__$1 = cljs.core.__destructure_map(map__36953);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36953__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36953__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36953__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__36956 = (function (){var or__4253__auto__ = color;
...
var fexpr__36955 = (function (){var G__36957 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__36957) : style_map.call(null,G__36957));
})();
return (fexpr__36955.cljs$core$IFn$_invoke$arity$1 ? fexpr__36955.cljs$core$IFn$_invoke$arity$1(G__36956) : fexpr__36955.call(null,G__36956));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__36958){
var vec__36959 = p__36958;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36959,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36959,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36959,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__36962){
var vec__36963 = p__36962;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36963,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36963,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36963,(2),null);
...
var G__37039 = cljs.core.next(ssv);
var G__37040 = (this_ssv == null);
var G__37041 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__37042 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__37039;
doing_nil_QMARK_ = G__37040;
last_elide = G__37041;
out = G__37042;
continue;
}
...
var vec__36971 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36971,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36971,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36971,(2),null);
...
var G__37043 = cljs.core.next(remaining_cvec);
var G__37044 = new_idx;
var G__37045 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__37043;
idx = G__37044;
out = G__37045;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__36989,cursor_vec){
var vec__36990 = p__36989;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36990,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36990,(1),null);
var focus_vec = vec__36990;
...
var vec__36993 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36993,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36993,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__36997){
var vec__36998 = p__36997;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36998,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36998,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__37005,existing_count){
var vec__37007 = p__37005;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37007,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37007,(1),null);
...
return cljs.core.filterv((function (p1__37002_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__37002_SHARP_))));
...
var vec__37016 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37016,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37016,(1),null);
var cvec_element = vec__37016;
if((cvec_element == null)){
var G__37057 = cljs.core.next(cvec_nl);
var G__37058 = (idx + (1));
var G__37059 = start;
var G__37060 = out;
cvec_nl = G__37057;
...
var G__37061 = cljs.core.next(cvec_nl);
var G__37062 = (idx + (1));
var G__37063 = idx;
var G__37064 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__37061;
idx = G__37062;
start = G__37063;
out = G__37064;
...
var G__37066 = cljs.core.next(cvec_nl);
var G__37067 = (idx + (1));
var G__37068 = (idx + (1));
var G__37069 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__37066;
idx = G__37067;
start = G__37068;
out = G__37069;
...
var G__37071 = cljs.core.next(cvec_nl);
var G__37072 = (idx + (1));
var G__37073 = idx;
var G__37074 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__37071;
idx = G__37072;
start = G__37073;
out = G__37074;
...
var G__37075 = cljs.core.next(cvec_nl);
var G__37076 = (idx + (1));
var G__37077 = start;
var G__37078 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__37075;
idx = G__37076;
start = G__37077;
out = G__37078;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37021_SHARP_,p2__37020_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__37020_SHARP_)){
return cljs.core.reduced(p1__37021_SHARP_);
} else {
return (p1__37021_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__37022,p__37023){
var vec__37025 = p__37022;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37025,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37025,(1),null);
var vec__37028 = p__37023;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37028,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37028,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__37033,cvec,focus_vec){
var map__37034 = p__37033;
var map__37034__$1 = cljs.core.__destructure_map(map__37034);
var options = map__37034__$1;
var map__37035 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37034__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__37035__$1 = cljs.core.__destructure_map(map__37035);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37035__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37035__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37035__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37032_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__37032_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
