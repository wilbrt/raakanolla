 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__31931){
var vec__31936 = p__31931;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31936,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31936,(1),null);
return (function (s){
...
var len__4864__auto___31991 = arguments.length;
var i__4865__auto___31993 = (0);
while(true){
if((i__4865__auto___31993 < len__4864__auto___31991)){
args__4870__auto__.push((arguments[i__4865__auto___31993]));

var G__31995 = (i__4865__auto___31993 + (1));
i__4865__auto___31993 = G__31995;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__31945_SHARP_){
return (p1__31945_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__31945_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__31945_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq31950){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq31950));
}));
...
var map__31967 = temp__5751__auto__;
var map__31967__$1 = cljs.core.__destructure_map(map__31967);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31967__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31967__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31967__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__32013 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__32014 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__31970 = tag;
