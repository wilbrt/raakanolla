...
var G__38198 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__38198__$1 = (((G__38198 == null))?null:cljs.core.iterate((function (loc){
...
var G__38198__$2 = (((G__38198__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38198__$1));
var G__38198__$3 = (((G__38198__$2 == null))?null:cljs.core.last(G__38198__$2));
if((G__38198__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__38198__$3);
}
} else {
return zloc;
}
...
var G__38216 = rewrite_clj.zip.move.right(v);
var G__38217 = rewrite_clj.zip.move.up(v);
loc = G__38216;
parent = G__38217;
continue;
} else {
var G__38218 = rewrite_clj.zip.move.right(v0);
var G__38219 = parent;
loc = G__38218;
parent = G__38219;
continue;
...
var G__38220 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__38221 = rewrite_clj.zip.move.up(v);
loc = G__38220;
parent = G__38221;
continue;
} else {
var G__38222 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__38223 = parent;
loc = G__38222;
parent = G__38223;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__38203 = zloc;
var G__38203__$1 = (((G__38203 == null))?null:rewrite_clj.zip.move.down(G__38203));
var G__38203__$2 = (((G__38203__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__38203__$1,k));
if((G__38203__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__38203__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__38205 = rewrite_clj.zip.move.down(zloc);
var G__38205__$1 = (((G__38205 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__38205));
if((G__38205__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38205__$1);
}
})(),k);
}
});
