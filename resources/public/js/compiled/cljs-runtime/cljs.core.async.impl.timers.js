...
var i_42861 = (0);
while(true){
if((i_42861 < arr.length)){
(arr[i_42861] = null);

var G__42862 = (i_42861 + (1));
i_42861 = G__42862;
continue;
} else {
}
...
var i_42875 = (self__.level + (1));
while(true){
if((i_42875 <= (new_level + (1)))){
(update[i_42875] = self__.header);

var G__42877 = (i_42875 + (1));
i_42875 = G__42877;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_42879 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_42879[i]));
} else {
x__$2.forward.push((((i < links_42879.length))?(links_42879[i]):null));
}

if((i < links_42879.length)){
(links_42879[i] = x__$2);
} else {
links_42879.push(x__$2);
}
...
var i_42883 = (0);
while(true){
if((i_42883 <= self__.level)){
var links_42884 = (update[i_42883]).forward;
if((x__$1 === (((i_42883 < links_42884.length))?(links_42884[i_42883]):null))){
(links_42884[i_42883] = (x__$1.forward[i_42883]));

var G__42885 = (i_42883 + (1));
i_42883 = G__42885;
continue;
} else {
var G__42886 = (i_42883 + (1));
i_42883 = G__42886;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__42897 = nx;
var G__42898 = (level__$1 - (1));
x = G__42897;
level__$1 = G__42898;
continue;
} else {
var G__42899 = x;
var G__42900 = (level__$1 - (1));
x = G__42899;
level__$1 = G__42900;
continue;
}
