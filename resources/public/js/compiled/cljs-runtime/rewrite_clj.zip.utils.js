...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__38040,k,f){
var vec__38041 = p__38040;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38041,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38041,(1),null);
var loc = vec__38041;
...
var G__38083 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__38083;
continue;
}
break;
...
var G__38089 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__38089;
continue;
} else {
return zloc__$1;
...
var G__38090 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__38090;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__38054){
var vec__38055 = p__38054;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38055,(0),null);
var map__38058 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38055,(1),null);
var map__38058__$1 = cljs.core.__destructure_map(map__38058);
var path = map__38058__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38058__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__38055;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__38059){
var vec__38060 = p__38059;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38060,(0),null);
var map__38065 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38060,(1),null);
var map__38065__$1 = cljs.core.__destructure_map(map__38065);
var path = map__38065__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38065__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__38060;
if(cljs.core.seq(r)){
...
var vec__38072 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38072,(0),null);
var map__38075 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38072,(1),null);
var map__38075__$1 = cljs.core.__destructure_map(map__38075);
var path = map__38075__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38075__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38075__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38075__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38075__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
