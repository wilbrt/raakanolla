...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__48684){
var vec__48685 = p__48684;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48685,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48685,(1),null);
...
return clojure.zip.zipper((function (p1__48689_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__48689_SHARP_)) || (cljs.core.map_QMARK_(p1__48689_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__48691){
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48700_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__48700_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48699_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48699_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48701_SHARP_){
return (((p1__48701_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__48701_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__48703,mapping){
var map__48704 = p__48703;
var map__48704__$1 = cljs.core.__destructure_map(map__48704);
var state = map__48704__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48704__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48704__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48704__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48702_SHARP_){
var and__4251__auto__ = (p1__48702_SHARP_ instanceof cljs.core.Symbol);
if(and__4251__auto__){
return cljs.core.namespace(p1__48702_SHARP_);
} else {
...
var G__48739 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__48741 = clojure.zip.next(loc);
loc = G__48741;
continue;
}
}
...
var len__4864__auto___48746 = arguments.length;
var i__4865__auto___48747 = (0);
while(true){
if((i__4865__auto___48747 < len__4864__auto___48746)){
args__4870__auto__.push((arguments[i__4865__auto___48747]));

var G__48748 = (i__4865__auto___48747 + (1));
i__4865__auto___48747 = G__48748;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__48708){
var vec__48709 = p__48708;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48709,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq48706){
var G__48707 = cljs.core.first(seq48706);
var seq48706__$1 = cljs.core.next(seq48706);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48707,seq48706__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48712_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48712_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__48714_48749 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__48715_48750 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__48716_48751 = true;
var _STAR_print_fn_STAR__temp_val__48717_48752 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__48716_48751);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__48717_48752);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__48715_48750);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__48714_48749);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48713_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__48713_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__48753 = cljs.core.next(opts__$1);
var G__48754 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__48753;
acc = G__48754;
continue;
} else {
if(typeof f === 'string'){
var G__48756 = cljs.core.next(opts__$1);
var G__48758 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__48756;
acc = G__48758;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__48759 = cljs.core.nnext(opts__$1);
var G__48760 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__48759;
acc = G__48760;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__48761 = cljs.core.next(opts__$1);
var G__48762 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__48761;
acc = G__48762;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__48720 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__48720.cljs$core$IFn$_invoke$arity$1 ? fexpr__48720.cljs$core$IFn$_invoke$arity$1(f) : fexpr__48720.call(null,f));
})())){
var G__48763 = cljs.core.next(opts__$1);
var G__48764 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__48763;
acc = G__48764;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__48721 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__48721.cljs$core$IFn$_invoke$arity$1 ? fexpr__48721.cljs$core$IFn$_invoke$arity$1(f) : fexpr__48721.call(null,f));
})())){
var G__48767 = cljs.core.nnext(opts__$1);
var G__48768 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__48767;
acc = G__48768;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__48769 = cljs.core.next(opts__$1);
var G__48770 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__48769;
acc = G__48770;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__48722){
...
var G__48727 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__48726 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48729 = quoted_form;
var G__48730 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48729,G__48730) : day8.re_frame.debux.common.util.remove_d.call(null,G__48729,G__48730));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48731 = quoted_form;
var G__48732 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48731,G__48732) : day8.re_frame.debux.common.util.remove_d.call(null,G__48731,G__48732));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__48775__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48733 = quoted_form;
var G__48734 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48733,G__48734) : day8.re_frame.debux.common.util.remove_d.call(null,G__48733,G__48734));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__48776__i < G__48776__a.length) {G__48776__a[G__48776__i] = arguments[G__48776__i + 0]; ++G__48776__i;}
  arg = new cljs.core.IndexedSeq(G__48776__a,0,null);
} 
return G__48775__delegate.call(this,arg);};
G__48775.cljs$lang$maxFixedArity = 0;
G__48775.cljs$lang$applyTo = (function (arglist__48777){
var arg = cljs.core.seq(arglist__48777);
return G__48775__delegate(arg);
});
...
var G__48778 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__48778;
continue;
} else {
...
var G__48779 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__48779;
continue;
} else {
var G__48780 = clojure.zip.next(loc);
loc = G__48780;
continue;
