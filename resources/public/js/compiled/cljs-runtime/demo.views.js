...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.gensym.cljs$core$IFn$_invoke$arity$1("row_")], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29849_SHARP_){
return demo.views.cell(n,p1__29849_SHARP_);
}),cljs.core.range.cljs$core$IFn$_invoke$arity$1(max)))], null);
});
demo.views.game = (function demo$views$game(){
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29850_SHARP_){
return demo.views.row(p1__29850_SHARP_,(20));
...
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"align","align",1964212802),"center"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),"Raaka Ristinolla"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2","h2",-372662728),(cljs.core.truth_(cljs.core.deref(game))?null:cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(result)))], null),((cljs.core.not(cljs.core.deref(game)))?demo.views.findmatch():null),(cljs.core.truth_(cljs.core.deref(game))?cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29851_SHARP_){
return demo.views.row(p1__29851_SHARP_,(20));
