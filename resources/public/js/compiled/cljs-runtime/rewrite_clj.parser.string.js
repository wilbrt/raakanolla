...
if((c === "\n")){
var G__37816 = escape_QMARK_;
var G__37817 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__37816;
lines = G__37817;
continue;
} else {
buf.append(c);

var G__37818 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__37819 = lines;
escape_QMARK_ = G__37818;
lines = G__37819;
continue;
...
var G__37806 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__37806) : rewrite_clj.node.string_node.call(null,G__37806));
});
...
var G__37807 = cljs.core.re_pattern(regex);
var G__37808 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__37807,G__37808) : rewrite_clj.node.token_node.call(null,G__37807,G__37808));
});
