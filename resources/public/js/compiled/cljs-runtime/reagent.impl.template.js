...
var G__34527 = o;
reagent.impl.template.goog$module$goog$object.set(G__34527,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__34528 = o;
reagent.impl.template.goog$module$goog$object.set(G__34528,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__34529 = props;
var G__34529__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34529,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34529);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34529__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__34530 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34530,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__34530;
}
})(),id_class);
...
var G__34531 = (cljs.core.count(argv) - first_child);
switch (G__34531) {
case (0):
...
var vec__34532 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34532,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34532,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34532,(2),null);
...
var temp__5757__auto___34574 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___34574 == null)){
} else {
var key_34576 = temp__5757__auto___34574;
(jsprops.key = key_34576);
}
...
var temp__5757__auto___34578 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___34578 == null)){
} else {
var key_34579 = temp__5757__auto___34578;
(jsprops.key = key_34579);
}
...
var temp__5757__auto___34583 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___34583 == null)){
} else {
var key_34586 = temp__5757__auto___34583;
...
var temp__5757__auto___34592 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___34592 == null)){
} else {
var key_34593 = temp__5757__auto___34592;
(jsprops.key = key_34593);
}
...
var temp__5757__auto___34595 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___34595 == null)){
} else {
var key_34596 = temp__5757__auto___34595;
(jsprops.key = key_34596);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34535_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__34535_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__34536 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34536,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34536,(1),null);
...
break;
default:
var G__34598 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__34599 = compiler;
v = G__34598;
compiler = G__34599;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template34548 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template34548 = (function (opts,id,fn_to_element,parse_fn,meta34549){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template34548.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34550,meta34549__$1){
var self__ = this;
var _34550__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template34548(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta34549__$1));
}));

(reagent.impl.template.t_reagent$impl$template34548.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34550){
var self__ = this;
var _34550__$1 = this;
return self__.meta34549;
}));

(reagent.impl.template.t_reagent$impl$template34548.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template34548.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template34548.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template34548.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template34548.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template34548.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta34549","meta34549",-1943449197,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template34548.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template34548.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template34548");

(reagent.impl.template.t_reagent$impl$template34548.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template34548");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template34548.
 */
reagent.impl.template.__GT_t_reagent$impl$template34548 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template34548(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta34549){
return (new reagent.impl.template.t_reagent$impl$template34548(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta34549));
});

}

return (new reagent.impl.template.t_reagent$impl$template34548(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
