...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_42998 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_42998(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_43000 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_43000(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_43002 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_43002(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_43003 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_43003(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_43004 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_43004(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_43005 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_43005(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__42995,callback){
var map__42996 = p__42995;
var map__42996__$1 = cljs.core.__destructure_map(map__42996);
var input = map__42996__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42996__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42996__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
