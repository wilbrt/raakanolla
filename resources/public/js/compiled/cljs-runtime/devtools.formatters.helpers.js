...
var G__28091 = devtools.prefs.pref(v);
v = G__28091;
continue;
} else {
return v;
...
}catch (e28039){var _e__27070__auto__ = e28039;
return false;
}})();
...
}catch (e28041){var _e__27070__auto__ = e28041;
return false;
}})();
...
}catch (e28047){var _e__27070__auto__ = e28047;
return false;
}}
}
});
...
var vec__28061 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28061,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28061,(1),null);
...
return cljs.core.some((function (p1__28073_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28073_SHARP_);
}),template);
});
